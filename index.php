  ...
  <body id="page-top">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#about">Venue</a>
            </li>
            <li class="nav-item">
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          ...
          <div class="intro-heading text-uppercase">Cari event yang kamu mau</div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Gather all the event to easy access !</h3>
          </div>
        </div>
        <div class="row text-center">
          <div class="col-md-4">
            ...
            <h4 class="service-heading">Feel Free!</h4>
            <p class="text-muted">Untuk penyelenggara kamu dapat mendaftarkan Event mu secara cuma-cuma diwebsite kami!</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
            ...
            <h4 class="service-heading">Computer Online Integrated</h4>
            <p class="text-muted">Kami menyediakan Real-Time proccess untuk Reservasi E-Ticket yang memudahkan kamu untuk memesan</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
    ...
    <section class="bg-light" id="portfolio">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">EVENT YANG ADA</h2>
              ...
              <li>
                ...
                <div class="timeline-panel">
                  ...
                  <div class="timeline-body">
                    <p class="text-muted">Gedung Graha Widya Wisuda (GWW) biasa digunakan untuk acara-acara besar seperti wisuda dan ospek. Cocok untuk kamu yang mengadakan event konser dan seminar dengan skala besar. Gedung ini bisa menampung sampai dengan 6000 orang. Kamu bisa menghubungi Direktorat pelayanan Biro Umum untuk menyewa GWW.</p>
                  </div>
                </div>
              </li>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input class="form-control" id="name" type="text" placeholder="Your Name *" required data-validation-required-message="Please enter your name." name= "name">
                  ...
                  <div class="form-group">
                    <input class="form-control" id="phone" type="tel" placeholder="Your Phone *" required data-validation-required-message="Please enter your phone number."name= "phone">
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
                <div class="col-md-6">
